...
if f1 is not None:
    ...
    os.chdir(r"C:\Users\ratho\Downloads\Dasboard\Projects")
...
with cl1:
    with st.expander("Category_ViewData"):
        ...
        st.download_button("Download_data",data=csv,file_name="category.csv",mime="text/csv",help="Click here to download the data as CSV file")
with cl2:
    with st.expander("Region_ViewData"):
        region = filtered_df.groupby(by="Region",as_index =False)['Sales'].sum()
        st.write(region.style.background_gradient(cmap="Oranges"))
        csv = region.to_csv(index=False).encode('utf-8')
        st.download_button("Download_data",data=csv,file_name="Region.csv",mime="text/csv",help="Click here to download the data as CSV file")
...
with st.expander("View Data for Timeseries:"):
    st.write(linechart.T.style.background_gradient(cmap= 'Purples'))
